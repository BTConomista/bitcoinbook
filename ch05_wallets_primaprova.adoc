...
chiave pubblica è noto come _modifica della chiave (key tweak)_. Se un algoritmo deterministico è
...
che ha utilizzato a un _dispositivo di firma hardware_ (a volte chiamato in modo fuorviante
...
singola sequenza, come descritto nella sezione seguente.
