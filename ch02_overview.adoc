...
Circa cinque minuti dopo un miner trova la soluzione valida e la comunica alla rete. Dopo che ogni miner ha validato il blocco vincente, essi avviano immediatamente una nuova lotteria per generare il prossimo blocco.
