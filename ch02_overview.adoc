...
// [REVISIONE]: coerenza terminologica — "invoice" viene reso qui come "_ordine di pagamento_" ma in ch01 (sezione Indirizzi Bitcoin) è tradotto come "richiesta di pagamento". Scegliere un'unica resa italiana per "invoice" e applicarla coerentemente in tutto il testo.
...
// [REVISIONE]: errore numerico — "168 miliardi di miliardi di miliardi" equivale a 10^27, non a 1,68 × 10^23 come indicato dalla notazione scientifica. L'originale dice "168 billion trillion" (scala corta americana): billion = 10^9, trillion = 10^12, quindi 168 × 10^21 = 1,68 × 10^23. La resa corretta in italiano (scala corta) è "168 miliardi di trilioni" (miliardi = 10^9, trilioni = 10^12). Correggere la parentesi esplicativa.
