...
Il whitepaper originale di Bitcoin descrive un sistema molto semplice per raggiungere questi obiettivi, mostrato in <<<pay-to-pure-pubkey>>>.
...
Un wallet Bitcoin contiene una raccolta di coppie di chiavi, ognuna composta da una chiave privata e una chiave pubblica. La chiave privata (_k_) è un numero, solitamente derivato da un numero scelto casualmente. A partire dalla chiave privata, utilizziamo la moltiplicazione su curva ellittica, una funzione crittografica unidirezionale, per generare la chiave pubblica (_K_).


[role="less_space pagebreak-before"]
.Perché usare la crittografia asimmetrica (chiavi pubbliche/privata)?
****
Perché la crittografia asimmetrica è utilizzata in Bitcoin?
