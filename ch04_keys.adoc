...
[[chiavi_private]]
==== 4.2 Chiavi private
Una chiave privata è semplicemente un numero scelto in modo casuale. Il controllo della chiave privata è la base del controllo dell'utente su tutti i fondi associati alla corrispondente chiave pubblica di Bitcoin.
