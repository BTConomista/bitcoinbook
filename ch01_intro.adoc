...
Ora Joe ha l’indirizzo Bitcoin di Alice impostato come destinatario. Inserisce quindi l’importo di 0,001 bitcoin (BTC); vedi <<wallet-send>>(figura 2).
