...
// [REVISIONE]: [FINDING-26-05-2026-003] "other transport networks can also be used" reso come "è possibile utilizzare altre reti"; "transport networks" indica reti di trasporto alternative a Internet (satellite, mesh, Tor), concetto tecnico più specifico. Suggerito: "è possibile utilizzare altre reti di trasporto".
// [REVISIONE]: [FINDING-26-05-2026-001] "The Bitcoin protocol stack" reso come "L'architettura stratificata del protocollo Bitcoin"; "stack" indica la pila protocollare gerarchica, non una generica architettura stratificata. Suggerito: "Lo stack del protocollo Bitcoin" o "Lo stack protocollare di Bitcoin".
// [REVISIONE]: [FINDING-26-05-2026-002] "can be run on a wide range of computing devices" reso come "è compatibile con un'ampia gamma di dispositivi"; "compatibile" è più debole di "eseguibile su". Suggerito: "può essere eseguito su un'ampia gamma di dispositivi di calcolo".
...
// [REVISIONE]: [FINDING-26-05-2026-005] La traduzione aggiunge "appendice A" non presente nell'originale: "(vedi appendice A <<satoshi_whitepaper>>)". Il cross-reference AsciiDoc si risolve autonomamente; la pre-qualifica è ridondante e fragile se la numerazione delle appendici cambia. Suggerito: "(vedi <<satoshi_whitepaper>>)".
// [REVISIONE]: [FINDING-26-05-2026-004] La convenzione del libro alla prima occorrenza è "termine EN (traduzione IT)" come "_network_ (rete)" e "_fees_ (commissioni)"; qui l'ordine è invertito: "doppia spesa (double-spend)". Per coerenza: "double-spend (doppia spesa)".
...
// [REVISIONE]: [FINDING-26-05-2026-008] "rimane ancora un mistero" è ridondante: "rimanere" esprime già continuità nel tempo e "ancora" ne duplica il senso. Suggerito: "rimane un mistero" oppure "è ancora un mistero".
// [REVISIONE]: [FINDING-26-05-2026-007] "individual control" reso come "controllo esclusivo"; "individual" significa "del singolo" (vs. controllo collettivo della comunità), "esclusivo" implica "che esclude altri" — sfumatura diversa. Suggerito: "controllo individuale".
...
// [REVISIONE]: [FINDING-26-05-2026-009] "an application that speaks the protocol" reso come "un'apposita applicazione", perdendo il dettaglio tecnico che l'applicazione implementa/parla il protocollo. Suggerito: "un'applicazione che implementa il protocollo" o "che parla il protocollo".
// [REVISIONE]: [FINDING-26-05-2026-010] "implementations and brands of Bitcoin wallets" reso come "implementazioni e versioni"; "brands" indica marchi/produttori diversi (es. Electrum, BlueWallet), non versioni dello stesso prodotto. Suggerito: "implementazioni e marche di wallet Bitcoin".
