...
https://bitcoinaverage.com[Bitcoin Average]:: Un sito che offre una vista semplice della media ponderata per volume per ciascuna valuta.
https://coincap.io[CoinCap]:: Un servizio che elenca la capitalizzazione di mercato e i tassi di cambio di centinaia di criptovalute, incluso bitcoin.
https://oreil.ly/ACieC[Chicago Mercantile Exchange Bitcoin Reference Rate]:: Un tasso di riferimento utilizzabile in ambito istituzionale e contrattuale, fornito dalla CME all'interno dei propri flussi di dati finanziari.
