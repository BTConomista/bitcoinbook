...
// [REVISIONE]: "central clearinghouse" reso come "ente di smistamento centrale": "smistamento" evoca instradamento fisico/postale, mentre "clearinghouse" è un termine finanziario (stanza di compensazione). Coerentemente con il commento in === La Storia di Bitcoin: preferire "stanza di compensazione centrale" o "clearing house centrale".
Si affidavano a un ente di smistamento centrale per regolare tutte le transazioni a intervalli regolari, similarmente a un sistema bancario tradizionale. Sfortunatamente, nella maggior parte dei casi, queste nuove valute digitali furono bersagliate da governi preoccupati e infine soppresse tramite azioni legali. Alcune fallirono rovinosamente con il crollo improvviso della società emittente.
