...
// [REVISIONE]: fedeltà: l'originale dice "half of the remaining coins are added to circulation every four years", cioè metà dei bitcoin rimanenti da estrarre viene aggiunta alla circolazione ogni quattro anni. La formulazione "vede dimezzare la quantità di bitcoin ancora da emettere" è una parafrasi che inverte il punto di vista (il totale residuo si dimezza invece di "metà dei rimanenti viene aggiunta"). Riformulare per mantenere il senso originale.
...
// [REVISIONE]: "internet of money" → "denaro di Internet" inverte il significato. La famosa metafora di Antonopoulos indica una "rete (internet) per il denaro" (analoga all'internet per l'informazione), non "il denaro di Internet". Suggerito: "l'_internet del denaro_" o "l'internet del valore".
Come sviluppatore, vedo Bitcoin come una sorta di "denaro di Internet", una rete per propagare valore e tutelare la proprietà di beni digitali mediante il calcolo distribuito. In Bitcoin c'è molto più di quanto possa sembrare a prima vista.
