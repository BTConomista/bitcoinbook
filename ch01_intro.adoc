...
==== 1.3 Una soluzione ad un problema di calcolo distribuito
...
==== 1.5 Scegliere un Wallet Bitcoin
...
===== 1.6.1 Client Full Node contro Client Leggero
...
<caption>Sample recovery codes (1.1)</caption>
<thead>
<tr>
<th>Wallet</th>
...
==== 1.12 Comprare i tuoi primi Bitcoin
...
==== 1.13 Trovare il prezzo attuale di bitcoin
...
[[sending_receiving]]
==== 1.14 Inviare e ricevere bitcoin
