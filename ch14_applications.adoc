...
allows building on the economies of scale of the Bitcoin LN, but it may be vulnerable to a problem called the _free American
...
The Lightning Network (LN) is a proposed routed network of
