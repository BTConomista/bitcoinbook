...
Le persone accettano denaro in cambio dei loro beni e servizi solo se credono che potranno spendere quel denaro successivamente. Denaro contraffatto o svalutato in maniera inattesa potrebbe non essere speso in futuro, perciò chiunque riceva bitcoin ha un forte incentivo a controllare attentamente l'integrità dei bitcoin che riceve. // [REVISIONE]: "altri problemi critici" omette "several" dell'originale ("several other critical problems") — preferire "diversi altri problemi critici"
...
Anche se Bitcoin Core rappresenta l'implementazione di riferimento per molte parti fondamentali del sistema, il whitepaper di Bitcoin descrive diverse delle prime componenti del sistema. // [REVISIONE]: l'originale usa "BIPs" (plurale con la s), che è la forma standard corretta della sigla. "Bitcoin Improvement Proposals (BIP)" omette la s del plurale — preferire "Bitcoin Improvement Proposals (BIPs)"
