...
// [REVISIONE]: L'originale dice "reduce the security of bitcoins in multisignature wallets" — la traduzione "compromettere la sicurezza dei bitcoin conservati in wallet multifirma" è imprecisa: il testo originale non dice che li "ruba" ma che "riduce la sicurezza" dei wallet multifirma (perché il seed controlla solo una delle chiavi). Suggerito: "...oltre a ridurre la sicurezza dei bitcoin conservati in wallet multifirma."
...
// [REVISIONE]: "supporti fisici" non è la resa corretta di "physical belongings" — l'originale parla di oggetti fisici in generale (non solo supporti di memorizzazione). Suggerito: "oggetti fisici" o "effetti personali fisici".
