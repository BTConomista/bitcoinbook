...
Sebbene i seed siano valori casuali di grandi dimensioni, solitamente compresi tra 128 e 256 bit, la maggior parte dei codici di recupero utilizza parole di una lingua naturale. La scelta di usare parole è motivata soprattutto dal desiderio di rendere il codice più facile da ricordare.
