...
// [REVISIONE]: L’originale dice "we learned how to create" — "abbiamo visto come creare" è accettabile ma "abbiamo imparato" sarebbe più fedele. Problema più importante: l’originale dice "it’s possible to add or subtract from a public key, or to multiply it" — la traduzione aggiunge "sommare, sottrarre o moltiplicare una chiave pubblica" che omette la preposizione "a/da": si sottrae *da* una chiave pubblica, non si "sottrae una chiave pubblica". Suggerito: "è possibile sommare o sottrarre un valore a/da una chiave pubblica, oppure moltiplicarla."
