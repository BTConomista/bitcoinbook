...
Le moderne applicazioni wallet non generano più le chiavi in modo indipendente, bensì le derivano da un singolo seed casuale attraverso un algoritmo ripetibile (deterministico).
...
Aezeed::
  ...
  Include anche una _data di creazione del wallet_
...
Tuttavia, se ti senti audace, ti incoraggiamo a esplorare standard
